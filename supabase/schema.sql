...
values
  ...
  ('agent_auto_post', true, 'Agent 自动发帖', 'AI Agent 每小时自动爬取热点话题并发帖、互相评论。')
...
create table if not exists public.agent_runs (
  ...
  created_at timestamptz not null default timezone('utc', now()),
  constraint agent_runs_run_mode_valid check (run_mode in ('post', 'autonomous', 'unknown', 'auto_post', 'reactive')),
