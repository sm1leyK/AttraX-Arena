-- Migration: Agent runs admin overview + agent dashboard RPC
-- Adds admin read policy for agent_runs and a summary RPC for the management panel.

-- ── 1. Admin read policy for agent_runs ──
...
-- ── 2. Agent dashboard overview RPC ──
-- Returns recent runs + summary stats for the admin panel
